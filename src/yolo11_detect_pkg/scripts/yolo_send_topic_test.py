...
# ===== 경로/하이퍼파라미터 =====
RKNN_PATH  = "/home/hightorque/soccer_ws/src/yolo11_detect_pkg/config/rknn/1020_best-rk3588.rknn"
YAML_PATH  = "/home/hightorque/soccer_ws/src/yolo11_detect_pkg/config/rknn/1020_metadata.yaml"  # 선택(없어도 OK)
...
DEFAULT_IMAGE_PATH = "/home/hightorque/soccer_ws/src/yolo11_detect_pkg/scripts/test.png"
...
class YoloInfo(object):
    ...
    def postprocess(self, outputs, meta):
        ...
        if C > 6:
            ...
            if 1.5 < maxv <= 255.0:
                obj /= 255.0; cls_probs /= 255.0
            elif 255.0 < maxv <= 65535.0:
                obj /= 65535.0; cls_probs /= 65535.0
